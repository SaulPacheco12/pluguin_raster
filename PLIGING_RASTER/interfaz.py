...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 60, 331, 411))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn2.setGeometry(QtCore.QRect(20, 330, 75, 23))
        self.btn2.setObjectName("btn2")
        self.btn3 = QtWidgets.QPushButton(self.groupBox)
        self.btn3.setGeometry(QtCore.QRect(130, 330, 75, 23))
        self.btn3.setObjectName("btn3")
        self.btn4 = QtWidgets.QPushButton(self.groupBox)
        self.btn4.setGeometry(QtCore.QRect(230, 330, 75, 23))
        self.btn4.setObjectName("btn4")
        self.label_4 = QtWidgets.QLabel(self.groupBox)
        self.label_4.setGeometry(QtCore.QRect(20, 150, 171, 16))
        self.label_4.setObjectName("label_4")
        self.TXedit = QtWidgets.QTextEdit(self.groupBox)
        self.TXedit.setGeometry(QtCore.QRect(20, 190, 281, 121))
        self.TXedit.setReadOnly(True)
        self.TXedit.setObjectName("TXedit")
